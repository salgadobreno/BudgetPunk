...
public class EntriesWithSeparatorAndSummaryListTest {
...
//        assertEquals(list.getEntryViewType(19), EntriesWithSeparatorAndSummaryList.EntryViewType.DAILY_IN);
        ...
        assertEquals(dailyAvailable, ((Entry)list.get(18)).getValue().getAmount().doubleValue(), 1f);
    }
...
//        assertEquals(list.getEntryViewType(16), EntriesWithSeparatorAndSummaryList.EntryViewType.DAILY_OUT);
        ...
        assertEquals((dailyAvailable) * -1, ((Entry)list.get(15)).getValue().getAmount().doubleValue(), 1f);
    }
    ...
    public void testDoesNotAddDailyOutForToday() throws Exception {
        ...
        //9  - Daily IN
        //10 - Summary
        assertEquals(-50d, ((Entry) list.get(6)).getValue().getAmount().doubleValue(), 1f);
        assertEquals(50d, ((Entry) list.get(9)).getValue().getAmount().doubleValue(), 1f);
