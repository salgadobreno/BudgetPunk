 ...
 */
//TODO: BUY ENTRIES
public class BuyEntriesWithSeparatorAndMofifierList extends ArrayList<Object> {
    ...
    public BuyEntriesWithSeparatorAndMofifierList(EntryByDateMap map, ILedger ledger) {
